...
/**
* @brief Destruye la lista creada y libera su memoria reservada
*/
	~Lista();


/**
* @brief Construye una nueva lista con los mismos elementos de old
*/
   Lista(const Lista &old);

/**
*  @brief Construye una nueva lista cuya cabecera apunta al inicio de la lista old
*/
   Lista operator=(const Lista &old);

/**
*  @brief Inserta una nueva cadena a la lista mediante el operador de suma
*/
